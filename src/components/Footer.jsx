        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0 font-display">
              ...
              <p className="text-[#DDA15E] font-display italic">Proof is participation. Privacy with presence.</p>
            </div>
          ...
          <div className="border-t border-[#DDA15E]/20 mt-8 pt-8 text-center font-mono">
            <p className="text-[#DDA15E]/80">© 2025 Proof of Witness. Built to Build ZK.</p>
          </div>
        </div>
      </footer>
  )
